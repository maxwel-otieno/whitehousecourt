const { Form, Link, useLoaderData, useActionData, useTransition, useCatch, useParams } = require("@remix-run/react");
const { json, redirect } = require("@remix-run/node");
const { marked } = require("marked");
const { createPost, deletePost, getPost, updatePost } = require("../../../models/post.server");
