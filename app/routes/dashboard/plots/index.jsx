const { ArrowLeftIcon, PlusIcon } = require("@heroicons/react/outline");
const { Link, Form, useLoaderData, useTransition, useSubmit, useActionData, useCatch } = require("@remix-run/react");
const { useRef, useEffect } = require("react");
// import { prisma } from "~/db.server";
const { createHouse, clearDatabase, getHouses, getSelectedHouses } = require("../../../models/house.server");
const { getTenants } = require("../../../models/tenant.server");
