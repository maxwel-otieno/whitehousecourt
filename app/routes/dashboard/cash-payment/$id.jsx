const { Form, useActionData, useLoaderData, useLocation, useTransition } = require("@remix-run/react");
const { redirect } = require("@remix-run/server-runtime");
const { useEffect } = require("react");
const { useRef } = require("react");
const { getTenant } = require("../../../models/tenant.server");
const { createTenantPayment } = require("../../../models/year.server");
const { getSession, sessionStorage } = require("../../../session.server");
const { badRequest, validateName, validatePhone, validateAmount } = require("../../../utils");
